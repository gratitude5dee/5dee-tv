...
export default function ConvexNotConfigured({ feature }: { feature: string }) {
  return (
    <div className="fal-card">
      <div className="fal-card-content text-center py-12 text-fal-gray-600 dark:text-fal-gray-400">
        <Database className="w-12 h-12 mx-auto mb-3 opacity-50" />
        <p className="font-medium text-fal-gray-900 dark:text-fal-gray-50">Convex is not configured</p>
