      ...
      {chart.names.map((name) => {
        ...
        return (
          <button
            ...
            className={cn(
              "flex items-center gap-1.5 font-mono text-[11px] text-gray-500 transition-opacity dark:text-gray-400",
              isClickable &&
                "pointer-events-auto cursor-pointer hover:text-gray-950 dark:hover:text-gray-50",
              dimmed && "opacity-40"
            )}
          >
            <span
