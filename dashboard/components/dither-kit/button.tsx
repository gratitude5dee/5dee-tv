...
export function DitherButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "relative isolate overflow-hidden rounded-md px-4 py-2 font-mono text-xs text-gray-950 transition-opacity focus-visible:ring-1 focus-visible:ring-gray-950/40 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-40 dark:text-gray-50 dark:focus-visible:ring-gray-50/40",
        className
      )}
      {...props}
    >
